...
class TimeLogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create time_log" do
    assert_difference("TimeLog.count") do
      post time_logs_url, params: { time_log: { time_spent: @time_log.time_spent, topic_id: @time_log.topic_id } }
    end
  ...
  test "should update time_log" do
    patch time_log_url(@time_log), params: { time_log: { time_spent: @time_log.time_spent, topic_id: @time_log.topic_id } }
